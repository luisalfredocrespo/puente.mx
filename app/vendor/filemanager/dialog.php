...
<!-- header div end  -->
	...
	?>
	<ul class="breadcrumb">	
    <?php if(!$_SESSION[token_variable('archivos'.$_GET['key'])][token_variable('des_breadcrumb')]){ ?>
	...
	<div class="span12">	    
		...
		foreach ($files as $file_array) {
			...
			?>
				...
				if($file=='..'){
					echo 'class="back"'; 
					echo (!$_SESSION[token_variable('archivos'.$_GET['key'])][token_variable('des_regresar')]) ?  '': 'style="display:none;"'; 
				}else{ 
					echo 'class="dir"'; 
				} 
					 ?>><?php  
...
?>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
				    ...
				    <?php /* <a title="<?php echo lang_Download?>" class="tip-right" href="javascript:void('')" onclick="$('#form<?php echo $nu; ?>').submit();"><i class="icon-download"></i></a> */?><a title="<?php echo lang_Download?>" class="tip-right" href="javascript:void('')" onclick="downloadbsk('<?php echo $rfm_subfolder.$subdir.$file; ?>')" href="<?php echo $rfm_subfolder.$subdir .$file; ?>"><i class="icon-download"></i></a> 
				    ...
				    <?php } 
					if(!in_array($file,$_SESSION[token_variable('archivos'.$_GET['key'])][token_variable('bloquer_archivos')])){
					?>
...
<script>
    function downloadbsk(int){
		/*alert('<?php echo RUTA_ACTUAL.'source/'.md5($_SESSION['usuario']['IDTBL_CLIENTES']); ?>'+int);*/
		window.open('<?php echo RUTA_ACTUAL.'source/'.md5($_SESSION['usuario']['IDTBL_CLIENTES']).'/'; ?>'+int,'_blank');
		}
</script>
