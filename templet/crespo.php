<div class="container"><!-- Container -->
               <h2 class="border-title aligncenter jmy_web_div" data-page="crespo" id="hola77"data-editor="no">
<?php $this->pnt('hola77','Curriculo'); ?>
</h2>
                 <font color=black><h4 class="aligncenter jmy_web_div" data-page="crespo" id="hola78"data-editor="no">
<?php $this->pnt('hola78',''); ?>
</h4></font>
         <div class="clear"></div>
 </div> 				
