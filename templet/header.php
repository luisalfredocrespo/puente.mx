...
<div class="wrapper"><!-- Wrapper -->
    <div class="inner-wrapper"><!-- Inner-Wrapper -->
        ...
        <header id="header" class="dt-sticky-menu type2"><!-- Header -->
        	<div id="logo"><!-- Logo -->
                <a title="unirem" href="<?php echo RUTA_ACTUAL.BASE_TEMPLET; ?>index.html"><img title="unirem" alt="unirem" src="<?php echo RUTA_ACTUAL.BASE_TEMPLET; ?>images/logoblanco3.fw.png"></a>
            </div><!-- End of Logo -->
            <div id="menu-container">
            	<div class="container">
                    <nav id="main-menu"><!-- Nav - Starts -->
                        ...
                        <a title="unirem" href="<?php echo RUTA_ACTUAL.BASE_TEMPLET; ?>index.html" class="sticky-logo"><img title="evolutionSalon" alt="evolution" src="<?php echo RUTA_ACTUAL.BASE_TEMPLET; ?>images/logo.png"></a>
                        <ul class="menu">
